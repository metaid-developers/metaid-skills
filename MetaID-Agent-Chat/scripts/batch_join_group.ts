...
/**
 * Batch join all known users from MetaID-Agent account.json to a specified group
...
const TARGET_GROUP_ID = 'c1d5c0c7c4430283b3155b25d59d98ba95b941d9bfc3542bf89ba56952058f85i0' // 🤖MetaID-Agent畅聊群
...
async function main() {
  ...
  console.log('🎯 批量加群: 🤖MetaID-Agent畅聊群')
